...
parser.add_argument('--slac-json', default='', help='Input SLAC JSON file location', required=True)
parser.add_argument('--output-dna', default='', help='Output Codon/DNA FASTA file location', required=True)
parser.add_argument('--output-aa', default='', help='Output Amino-Acid FASTA file location', required=True)
parser.add_argument('--output-codon-msa', default='', help='Output Multiple sequence alignment FASTA file location', required=True)
parser.add_argument('--output-aa-msa', default='', help='Output Multiple sequence alignment FASTA file location', required=True)
...
with open(args.output_codon_msa, 'w') as handle:
    for k in data_dict_DNA:
        print("# Writing:", k)
        sp = k
        #molecule = data_dict_DNA[k].replace("---", "")
...
with open(args.output_aa_msa, 'w') as handle:
    for k in data_dict_AA:   
        print("# Writing:", k)
